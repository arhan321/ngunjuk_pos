        ...
        <section class="ng-role-detail-hero-grid">
            ...
            <article class="ng-widget-card ng-role-profile-card">
                <div class="ng-role-avatar">
                    <?php echo e(mb_strtoupper(mb_substr($roleName, 0, 1))); ?>

                </div>

                <div class="ng-profile-info">
                    <span>Role Terpilih</span>
                    <strong><?php echo e($roleName); ?></strong>
                    <small><?php echo e(number_format($permissions->count(), 0, ',', '.')); ?> permission</small>
                </div>
            </article>
        </section>
            ...
            <article class="ng-widget-card ng-role-info-card">
                ...
                <div class="ng-info-list">
                    ...
                    <div>
                        ...
                        <strong><?php echo e($guardName); ?></strong>
                    </div>

                    <div>
                        <span>Total Permission</span>
                        <strong><?php echo e(number_format($permissions->count(), 0, ',', '.')); ?></strong>
                    </div>

                    <div>
                        <span>ID Role</span>
                        <strong>#<?php echo e($role->id); ?></strong>
                    </div>

                    <div>
                        <span>Dibuat</span>
                        <strong><?php echo e($role->created_at?->translatedFormat('d F Y H:i') ?? '-'); ?></strong>
                    </div>

                    <div>
                        <span>Terakhir Update</span>
                        <strong><?php echo e($role->updated_at?->translatedFormat('d F Y H:i') ?? '-'); ?></strong>
                    </div>
                </div>
            </article>
            ...
            <article class="ng-widget-card ng-role-summary-card">
                ...
                <div class="ng-access-summary">
                    <div class="ng-big-number">
                        <?php echo e(number_format($permissions->count(), 0, ',', '.')); ?>
                    ...
                    <span>
                        Role <?php echo e($roleName); ?> memiliki <?php echo e(number_format($permissions->count(), 0, ',', '.')); ?>
        ...
        <section class="ng-widget-card ng-role-permission-card">
            <div class="ng-card-head">
                ...
                <span class="ng-permission-count-pill">
                    <?php echo e(number_format($permissions->count(), 0, ',', '.')); ?> Permission
                </span>
            </div>
            ...
            <div class="ng-permission-list">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div class="ng-permission-item">
                        ...
                        <strong>
                            <?php echo e(str($permission->name)->replace('_', ' ')->replace('.', ' ')->title()); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/filament/admin/resources/roles/pages/view-role.blade.php ENDPATH**/ ?>